...
console.log(jsCourse.getDescription()); // Programming Course: Intro to JavaScript in JavaScript - 40 hours
console.log(uiCourse.getDescription()); // Design Course: UX Fundamentals using Figma, Sketch - 30 hours