...
//
//     const duneMovie = new Movie(1, "Dune: Part Two", new Date("2024-03-01"), "Denis Villeneuve");
//
//     const theLastOfUsSeries = new Series(2, "The Last of Us", new Date("2023-01-15"), "http://hbo.com/the-last-of-us");
//
//     const inceptionMovie = new Movie(3, "Inception", new Date("2010-07-16"), "Christopher Nolan");
//
//     const theCrownSeries = new Series(4, "The Crown", new Date("2016-11-04"), "http://netflix.com/the-crown");
//
